...
We will access the `io-biodiversity` collection from the [Microsoft Planetary Computer STAC catalog](https://planetarycomputer.microsoft.com/dataset/io-biodiversity). This dataset estimates the terrestrial Biodiversity Intactness Index (BII) as 100-meter gridded maps for 2017-2020. This data was generated by [Impact Observatory](https://www.impactobservatory.com/) in along with [Vizzuality](https://www.vizzuality.com/). The link to access the data directly is as follows: https://planetarycomputer.microsoft.com/api/stac/v1 

### Phoenix Subdivision Shapefile
Arizona county subdivision data was downloaded from the [U.S. Census Bureau](https://www.census.gov/geographies/mapping-files/time-series/geo/tiger-line-file.2020.html#list-tab-790442341). This data is a shapefile that represents vector geospatial data. To download the correct file, select 2020 for the year and County Subdivisions as the layer type. Then, choose Arizona as the state and download. 
